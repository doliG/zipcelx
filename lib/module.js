...
var generatorCellNumber = (function (index, rowNumber) {
  return "".concat(generateColumnLetter(index)).concat(rowNumber);
});

var generatorStringCell = (function (index, value, rowIndex) {
  return "<c r=\"".concat(generatorCellNumber(index, rowIndex), "\" t=\"inlineStr\"><is><t>").concat(escape(value), "</t></is></c>");
});

var generatorNumberCell = (function (index, value, rowIndex) {
  return "<c r=\"".concat(generatorCellNumber(index, rowIndex), "\"><v>").concat(value, "</v></c>");
});
...
var formatRow = (function (row, index) {
  ...
  return "<row r=\"".concat(rowIndex, "\">").concat(rowCells, "</row>");
});
...
var zipcelx = (function (config) {
  ...
  return zip.generateAsync({
    ...
    FileSaver.saveAs(blob, "".concat(config.filename, ".xlsx"));
  });
});

exports.generateXMLWorksheet = generateXMLWorksheet;
exports.default = zipcelx;
